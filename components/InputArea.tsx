...
const InputArea: React.FC<InputAreaProps> = ({ onSendMessage, isLoading }) => {
  ...
  return (
    <div className="w-full mx-auto">
      <div className="relative flex items-end gap-2 bg-black border border-white/10 p-1 group focus-within:border-brand-500 transition-all">
        ...
        <button
          ...
          className="p-3 bg-brand-600 hover:bg-brand-500 text-white disabled:bg-gray-900 transition-all"
        >
